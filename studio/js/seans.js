...
/** Varsayılan pomodoro bloğu. 25/5 değil, çünkü ölçüt sınav:
    HMGS 150 dakika kesintisizdir (bkz. views/exam.js DURATION_MS).
    25 dakikalık bloklarla çalışan bir kafa, 150 dakikanın son yarısında
  ...
  el.innerHTML = `
    <div class="mola-kart">
      ...
      <p class="mola-not" style="margin:0.9rem 0 0">
        Sınav 150 dakika kesintisizdir. 25 dakikalık bloklarla çalışan kafa,
        o 150 dakikanın ikinci yarısını ilk kez sınavda görür.
      </p>
    </div>`;
...
export const _test = { IDLE_MS, DEFAULT_WORK_MIN, DEFAULT_BREAK_MIN };

...
export function richBlock(s) {
  ...
  //    Parantezli harf "(C)" cümle içinde şıkka ATIFTIR, tahlil başlangıcı değil
  //    ("... görev yapmış olma (C) ve kendi ..."); yalnız metin başında ya da
  //    cümle sonundan (. ; :) sonra geliyorsa tahlil sayılır.
  raw = raw.replace(/(^|[.;:]\s+)\(([A-Ea-e])\)\s+/g, '$1\n$2) ');
